...
module design_1
  ...
  wire [11:0]axi_smc_M03_AXI_ARADDR;
  ...
  wire [11:0]axi_smc_M03_AXI_AWADDR;
  ...
  wire clk_enable_1;
  wire [31:0]new_7_0_addr_im;
  wire [31:0]new_7_0_addr_im_op;
  wire [31:0]new_7_0_addr_re;
  wire [31:0]new_7_0_addr_re_op;
  wire [7:0]new_7_0_output_im;
  wire [7:0]new_7_0_output_re;
  wire new_7_0_ready;
  wire [0:0]rst_ps8_0_96M_peripheral_aresetn;
  wire [3:0]util_vector_logic_0_Res;
  wire [7:0]xlslice_0_Dout;
  wire [7:0]xlslice_1_Dout;
  wire [31:0]zero_pad_8_to_32_0_out_data;
  wire [31:0]zero_pad_8_to_32_1_out_data;
  ...
  assign clk_enable_1 = clk_enable;
  ...
  design_1_axi_bram_ctrl_3_1 axi_bram_ctrl_4
  ...
  design_1_blk_mem_gen_0_3 blk_mem_gen_3
       (.addra(new_7_0_addr_re_op),
        ...
        .dina(zero_pad_8_to_32_0_out_data),
        ...
        .wea({new_7_0_ready,new_7_0_ready,new_7_0_ready,new_7_0_ready}),
        .web(axi_bram_ctrl_3_BRAM_PORTA_WE));
  design_1_blk_mem_gen_3_0 blk_mem_gen_4
       (.addra(new_7_0_addr_im_op),
        .addrb({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_4_BRAM_PORTA_ADDR}),
        .clka(zynq_ultra_ps_e_0_pl_clk0),
        .clkb(axi_bram_ctrl_4_BRAM_PORTA_CLK),
        .dina(zero_pad_8_to_32_1_out_data),
  ...
  design_1_new_7_0_1 new_7_0
       (.addr_im(new_7_0_addr_im),
        .addr_im_op(new_7_0_addr_im_op),
        .addr_re(new_7_0_addr_re),
        .addr_re_op(new_7_0_addr_re_op),
        .clk(zynq_ultra_ps_e_0_pl_clk0),
        .clk_enable(clk_enable_1),
        .input_im(xlslice_1_Dout),
        .input_re(xlslice_0_Dout),
        .output_im(new_7_0_output_im),
        .output_re(new_7_0_output_re),
        .ready(new_7_0_ready),
        .reset_x(rst_ps8_0_96M_peripheral_aresetn));
  ...
  design_1_util_vector_logic_0_0 util_vector_logic_0
       (.Op1({clk_enable_1,clk_enable_1,clk_enable_1,clk_enable_1}),
  ...
  design_1_xlslice_0_1 xlslice_1
       (.Din(blk_mem_gen_1_doutb),
        .Dout(xlslice_1_Dout));
  design_1_zero_pad_8_to_32_0_0 zero_pad_8_to_32_0
       (.in_data(new_7_0_output_re),
        .out_data(zero_pad_8_to_32_0_out_data));
  design_1_zero_pad_8_to_32_0_1 zero_pad_8_to_32_1
       (.in_data(new_7_0_output_im),
        .out_data(zero_pad_8_to_32_1_out_data));
